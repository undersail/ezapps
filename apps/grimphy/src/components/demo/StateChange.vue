...
function draw() {
  ...
  ctx.strokeStyle = '#94a3b8'
  ctx.beginPath()
  ctx.moveTo(tx, 70); ctx.lineTo(tx, 240); ctx.stroke()
  ctx.beginPath()
  ctx.arc(tx, 255, 18, 0, Math.PI * 2)
  ctx.stroke()
  // 液柱（-20 ~ 120 映射 70-240）
  ...
  ctx.lineWidth = 4
  ctx.beginPath()
  ctx.moveTo(tx, 240 - hgt); ctx.lineTo(tx, 240); ctx.stroke()
  ctx.fillStyle = '#ef4444'
  ctx.beginPath()
  ctx.arc(tx, 255, 14, 0, Math.PI * 2)
  ctx.fill()
